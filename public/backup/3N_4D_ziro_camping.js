...
const Ziro_camping = ({ data, base_url, faqdata }) => {
  ...
  return (
    <>
      ...
      <Head>
        <title>
          3N-4D Camping at Ziro Festival of Music 2024| Encamp Adventures
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="3N-4D Camping at Ziro Festival of Music 2024 | Encamp Adventures"
        />
        <meta
...
export async function getServerSideProps() {
  ...
  const data = {
    name: "3N-4D Encamp ZFM 2024 Package",
    youtubeurl: "https://www.youtube.com/embed/S_-f0OxyU3U?si=O5SVNIV1jcqai5IM",
    tripdetails:
      "3N-4D Twin Sharing Dome Tent Stay + Complimentary Breakfast + Campsite Facilities",
    duration: { from: "2024-09-27", to: "2024-09-30" },
    simillartrip: [
      { name: "2N-3D Package", link: "/2N_3D_ziro_camping" },
