...
return ( 
    ...
    <section className="review__area review_destination" >
                    ...
                    <div className="review__top__blk">
                        <div className="review__left__blk">
                            <div className="review__google__logo">
                                <span><Image src="/assets/img/google.png" alt="google" height='38px' width='100%'/></span>
                                <h6>Rating</h6>
                            </div>
                         ...
                         <OwlCarousel nav={false}  className="testimonial__main__slider" responsive={responsive}  loop = {true} margin={40} stagePadding={25}  responsiveClass= {true}>
                            ...
                            <div className="single__review__item">
                                <div className="profile__thumb">
                                    <span>
                                      <Image src="/assets/img/profile_1.png" alt="profile_1" object-fit='contain' layout='fill'/>
                                    </span>
                                ...
                                <div className="review__inner__logo">
                                     <Image src="/assets/img/google_logo.png" alt="google_logo" width='100%' height='38px'/>
                                </div>
                            </div>

                            <div className="single__review__item">
                                <div className="profile__thumb">
                                    <span><Image src="/assets/img/profile_1.png" alt="profile_1" object-fit='contain' layout='fill'/></span>
                                    <div className="profile__review">
