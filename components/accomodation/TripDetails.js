...
const {AOS,images,base_url ,toggle,setToggle,setToggles,toggles,description,totalcf,nameite,totalpricetag,locationdetails,instabooking,togglesx,setTogglesx} = props;
                            ...
                            <ul className="nav nav-tabs" id="myTab" role="tablist">
                                <li className="nav-item" role="presentation">
                                    <button onClick={()=>router.push('#tripdetails')} className="nav-link active" id="home-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true">Accommodation details</button>
                    ...
                    <div className="col-lg-4">
                        <div className="details__sitebar__main" data-aos="fade-left" data-aos-delay="50"
                            ...
                            <div className="sitebar__price modified">
                                <img src={`${base_url}/assets/img/price_tag.svg`} alt="tag"/>
                                 <span><i className="fa fa-inr"></i>{totalpricetag}</span>

                            </div>
                            <div className="trip__sitebar__title">
                                <h4 style={{fontSize:'1.2rem'}}>Accommodation summary</h4>
                                <p>{nameite}</p>
                            </div>
                            <div className="trip__sitebar__locations">
                                <span><i className="fa fa-map-marker-alt"></i></span>
                                 {
                                    locationdetails && locationdetails.length > 0 ? locationdetails.map((detail,key)=>{
                                     return (
                            ...
                            {
                        instabooking || instabooking === 1 ?
                            <div className="sitebar__btn__blk">
                                <div className="common__btn sidebar-open" style={{width:'100%',cursor:'pointer'}} onClick={()=>setToggle(!toggle)}>Book Now</div>
                            </div> :
                        ...
                        <div className="bg-lightGreen-300 rounded-lg p-20">
                           ...
                           <p style={{ fontSize: "0.8rem", color: "var(--bs-body-color)" }}>
